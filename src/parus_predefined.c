...
Lexicon* predefined_lexicon() {
	...
	lexicon_define(lex, "define", new_parusdata_base_prc(&define));
	lexicon_define(lex, "delete", new_parusdata_base_prc(&delete));
	...
	lexicon_define(lex, "length", new_parusdata_base_prc(&length));
